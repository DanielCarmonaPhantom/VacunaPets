...
export class ModalEditPet extends LitElement {
    ...
    constructor() {
      ...
      sandbox.on('abrir-modal-edit-pet',this.showDialog.bind(this));
    }
        ...
        <div class="modal-dialog ">
            <div class="modal-content shadow p-3 mb-5 rounded">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Editar a ${this.petName}</h1>
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" @input="${this.updateNombre}" value='${this.petName}'>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputText" class="col-sm-4 col-form-label">Typo de la mascota</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" @input="${this.updateEspacie}" value='${this.petType}'>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <textarea class="form-control" style="height: 100px" @input="${this.updateDescripcion}">${this.petDescription}</textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" @click="${this._updatePet}">Guardar mascota</button>
                </div>
            </div>
        </div>
        </div>
...
customElements.define('modal-edit-pet',ModalEditPet);